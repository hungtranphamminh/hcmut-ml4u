...
export default function AlumnisGroup({
  ...
  return (
    <div className="w-full flex items-center justify-center bg-white xl:py-[120px] pt-[60px] pb-20">
      <section className="2xl:max-w-[1440px] flex items-start justify-center 2xl:px-20 px-6 w-full">
        ...
        >
          <div className="max-w-[300px] ml-4 font-geist">
            <h2 className="text-xl md:text-4xl font-bold text-left md:my-8 my-4  uppercase bg-[url('/images/background.jpg')] bg-[left_45%_top_55%] bg-clip-text text-transparent">
              Alumni <br />
              <span className="text-black font-light">Team Members</span>
            </h2>
            <p className="text-black font-light text-left text-sm md:text-base">
